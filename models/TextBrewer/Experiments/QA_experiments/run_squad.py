...
from transformers import CamembertConfig, CamembertForQuestionAnswering, CamembertTokenizer


from utils import prepare_validation_features, prepare_train_features
...
def evaluate(args, model, tokenizer, eval_dataset, pad_token_label_id, mode, prefix=""):
...
def get_parse():
    ...
    parser.add_argument("--pad_on_right", default=True, type=ast.literal_eval)
...
def main():
    ...
    def predict_callback(model,step):
        ...
        if args.do_predict and args.local_rank in [-1, 0]:
            ...
            evaluate(args, model, tokenizer, pad_token_label_id, mode="test")
        model.train()
    # Training
    if args.do_train:
