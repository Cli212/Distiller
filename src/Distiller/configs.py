...
def parse():
    ...
    ## optional arguments
    parser.add_argument("--task_name", type=str, default="cola", choices=["cola", "sst-2", "mrpc", "stsb", "qqp", "mnli", "mnli-mm","qnli", "rte", "wnli"], help="Only used when task type is glue")
    ...
    parser.add_argument("--intermediate_loss_type", type=str, default="ce", choices=["ce","mse","cos","pkd","nce","mi"])
