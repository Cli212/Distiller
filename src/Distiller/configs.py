...
def parse():
    ...
    ## optional arguments
    parser.add_argument("--task_name", type=str, default="cola", choices=["cola", "sst-2", "mrpc", "stsb", "qqp", "mnli", "mnli-mm","qnli", "rte", "wnli", "kaggle"], help="Only used when task type is glue")
